...
/**
 * Cài đặt Storage dùng định dạng JSON (không dùng thư viện ngoài).
...
public class JsonStorage implements Storage {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(path))) {
            ...
            for (int i = 0; i < transactions.size(); i++) {
                ...
                if (t instanceof RecurringExpense) {
                    ...
                    if (t instanceof Income) {
                        // source đã ghi ở trên, cần xóa dấu phẩy cuối → dùng trick
                    }
                    // Ghi trường cuối
    ...
    /**
     * Parse đơn giản JSON array chứa các object phẳng (không lồng nhau).
